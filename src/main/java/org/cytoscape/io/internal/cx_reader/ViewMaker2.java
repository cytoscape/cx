...
public final class ViewMaker2 {
        ...
        if (cmf != null) {
            ...
            while (true) {
                ...
                if ((l != null) && (e != null) && (g != null)) {
                    ...
                    try {
                    	value = ViewMaker2.toTypeValue(ov, type);
    ...
    public final static void addDiscreteMapping(final VisualStyle style,
        ...
        try {
	        ...
	        while (true) {
                ...
                Object key = ViewMaker2.toTypeValue(k, type);
                try {
	...
	private static void parseVisualProperty(final String key, 
            ...
            if (is_mapping) {
                ...
                final Class<?> type_class = ViewMaker2.toClass(type);
                if (vp != null) {
                    if (mapping == 'p') {
        ...
        edgeProps.forEach(vpe -> {
            if (vpe != null) {
                ...
                if (props != null) {
                    ...
                    ViewMaker2.setVisualProperties(lexicon, props, v, CyEdge.class);
                }
            }
        });
    ...
    public final static void setNodeVisualProperties(final CyNetworkView view,
        ...
        nodeProps.forEach(vpe -> {
            ...
            if (props != null) {
                ...
                ViewMaker2.setVisualProperties(lexicon, props, v, CyNode.class);
            }
        });
            ...
            for (final Map.Entry<String, String> entry : props.entrySet()) {
                ...
                if (vp != null) {
                	try	{
	                    ...
	                    if (parsed_value != null) {
	                        if (ViewMaker2.shouldSetAsLocked(vp)) {
...
//        }
        ...
        if (have_default_visual_properties) {
            ...
            while (counter < 101) {
                if (ViewMaker2.containsVisualStyle(viz_style_title, visual_mapping_manager)) {
        ...
        ViewMaker2.setDefaultVisualPropertiesAndMappings(lexicon,
        ...
        nodeBypass.forEach((suid, props) -> {
        	...
        	ViewMaker2.setNodeVisualProperties(view, lexicon, node, props);	
        });
        
        edgeBypass.forEach((suid, props) -> {
        	CyEdge edge = niceCy.getEdge(suid);
        	ViewMaker2.setEdgeVisualProperties(view, lexicon, edge, props);	
        });
        ...
        ViewMaker2.applyStyle(new_visual_style, view, doLayout);
