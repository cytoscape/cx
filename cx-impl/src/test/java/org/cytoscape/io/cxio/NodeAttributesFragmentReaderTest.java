...
public class NodeAttributesFragmentReaderTest {
    ...
    public void test() throws IOException {
        ...
        //
        // assertTrue("failed to parse " + NodeAttributesElement.NAME +
        // " aspect",
        // r0.containsKey(NodeAttributesElement.NAME));
        // assertFalse("failed to parse " + NodeAttributesElement.NAME +
        // " aspect", r0.get(NodeAttributesElement.NAME)
        // .isEmpty());
        // assertTrue("failed to get expected number of " +
        // NodeAttributesElement.NAME + " aspects",
        // r0.get(NodeAttributesElement.NAME).size() == 5);
        //
        // final List<AspectElement> aspects =
        // r0.get(NodeAttributesElement.NAME);
        //
        // final NodeAttributesElement na1 = (NodeAttributesElement)
        // aspects.get(0);
        ...
        //
        // final NodeAttributesElement na2 = (NodeAttributesElement)
        // aspects.get(1);
        ...
        //
        // final NodeAttributesElement na3 = (NodeAttributesElement)
        // aspects.get(2);
        ...
        //
        // final NodeAttributesElement na4 = (NodeAttributesElement)
        // aspects.get(3);
