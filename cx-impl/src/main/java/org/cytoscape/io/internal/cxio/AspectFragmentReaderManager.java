...
public final class AspectFragmentReaderManager {
    ...
    public final Set<AspectFragmentReader> getAvailableAspectFragmentReaders() {
        ...
        final AspectFragmentReader edge_attributes_handler = new EdgeAttributesFragmentReader();
        final AspectFragmentReader node_attributes_handler = new NodeAttributesFragmentReader();
